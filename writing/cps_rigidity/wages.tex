...
\abstract{
            I construct a dataset from the monthly CPS micro-data files to measure
            wage rigidity. I find that the wages of workers in existing relationships
            are rigid, while the wages of newly hired workers are more flexible.
}
...
% I will not be able to differentiate between these three effects.
% My results will be for the combined effect: the change in wages due to a change in productivity.
