...
I use a a relatively simple model similar to \cite{daly_hobijn_2013} to examine the distribution of wage changes.  % ugh.
...
\begin{center}
  \noindent \includegraphics[width=\linewidth]{wage_schedule_flex_rigid.png}  % TODO: Label your axes.
